        ...
        <div className="container">
            ...
            <div id="feature">
                <div className="feature_items content_section">
                    {features.map(feature => {
                        return (
                            <div className="feature_item" key={feature.Id} onClick={() => onClickFeature(feature.Handler)}>
            ...
            <div id="department">
                <div className="content_section" style={{ color: '#f8f8f8' }}>
                    ...
                    <h2 className="section_title" style={{ color: '#f8f8f8' }}>Các chuyên khoa của bệnh viện</h2>
                    <Swiper
                    ...
                    >
                        {departments.map(item => {
                            return (
                                <SwiperSlide key={item.Id} className="department_item">
                                    {item.Name}
                                </SwiperSlide>
                            )
                        })}
            ...
            <div id="professor">
                <div className="content_section">
                    ...
                    <p className="subtitle">Gặp gỡ và tìm hiểu về đội ngũ chuyên gia, bác sỹ hàng đầu và giàu kinh nghiệm tại Bệnh viện Đa khoa Thành phố Vinh</p>
                    <Swiper
                        modules={[Navigation, Pagination, Scrollbar, A11y]}
                        loop={true}
                        slidesPerView={4}
            ...
            <div id="subcribe">
                <div className="content_section" style={{ display: "flex", flexDirection: "column", alignItems: 'center' }}>
                    <h2 className="section_title">Đăng ký</h2>
                    <p className="subtitle">Nhận tin tức mới nhất từ Bệnh viện Đa khoa Thành phố Vinh</p>
            ...
            <div id="links">
                <div className="content_section">
                    ...
                    >
                        {links.map(link => {
                            return (
                                <SwiperSlide key={link.Id} className="link_item">
                                    <a target="_blank" href={link.Url} rel="noreferrer" >
                                        <img alt="" src={replaceImageUrl(link.Image)} />
                                    </a>
                                </SwiperSlide>
                            )
                        })}
